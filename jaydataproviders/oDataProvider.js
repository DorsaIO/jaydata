...
(0, _core.$C)('$data.storageProviders.oData.oDataProvider', _core2.default.StorageProviderBase, null, {
        ...
        switch (this.providerConfiguration.dbCreation) {
            case _core2.default.storageProviders.DbCreationType.DropAllExistingTables:
                ...
                if (this.providerConfiguration.serviceUrl) {
                    ...
                    this.appendBasicAuth(requestData[0], this.providerConfiguration.user, this.providerConfiguration.password, this.providerConfiguration.withCredentials, this.providerConfiguration.withCredentials.accessToken);
    ...
    appendBasicAuth: function appendBasicAuth(request, user, password, withCredentials, accessToken) {
        request.headers = request.headers || {};
